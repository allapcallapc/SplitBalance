...
/// small stable string key instead and look it up here.
///
/// This covers every icon in Flutter's built-in (filled) Material Icons
/// set, keyed by its `Icons.<key>` identifier name, generated from
/// https://github.com/flutter/flutter/blob/stable/packages/flutter/lib/src/material/icons.dart
/// (filtering out the _outlined/_rounded/_sharp style variants - only the
/// default filled style is offered). Regenerate by re-running that filter
/// and diffing; never remove existing keys, since old rows may still
/// reference them.
